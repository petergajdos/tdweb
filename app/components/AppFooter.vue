<template>
  ...
  <footer class="backdrop-blur-lg py-6 px-4 sm:px-6">
    <div class="max-w-[960px] mx-auto">
      <div class="rounded-full border border-white/10 bg-white/20 px-4 sm:px-6 py-3 sm:py-4 flex flex-col lg:flex-row items-center justify-between gap-4 lg:gap-6">
        <!-- Logo Icon -->
