...
const integrations = [
  { name: 'Google Ads', image: '/images/icons/google-ads.svg', offset: -20 },
  { name: 'Meta Ads', image: '/images/icons/meta-ads.svg', offset: 20 },
  { name: 'Slack', image: '/images/icons/slack.svg', offset: 40 },
  { name: 'Google Analytics', image: '/images/icons/ga-icon.svg', offset: 20 },
  { name: 'BigQuery', image: '/images/icons/bigquery.svg', offset: -20 }
]
</script>
...
<template>
  <div class="relative w-full max-w-[512px] h-[400px] sm:h-[500px] xl:h-[550px] shrink-0">
    ...
    <div class="hidden sm:flex absolute right-[-10px] top-[80px] sm:top-[100px] flex-col gap-[12px] sm:gap-[16px] z-10 animate-float-container">
      <div
      ...
      >
        <img :src="integration.image" :alt="integration.name" class="w-6 h-6 sm:w-7 sm:h-7 object-contain" loading="lazy" />
      </div>
    </div>
  </div>
</template>
